...
venue: "The Black Women in Computational Biology Network"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "Sep 27, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "11:00 am EST"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
helper: ["Kaylyn Clark", "Jeticia Sistrunk"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["profdev@blackwomencompbio.org","rhondenewint93@gmail.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
...
<p>
  Below is a zip file containing all of the data files you will need for the workshop:
</p>
<ul>
